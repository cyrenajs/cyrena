...
const isReactComponent = val => val && val.$$typeof === Symbol.for('react.element') &&
...
export function ReactRealm(_sources) {
    ...
    const subVdomWithAmendedProps = cloneDeepWith(val => {
    ...
    return {
        react: xs.of(pragma(Fragment, null, ...castArray(subVdomWithAmendedProps))),
        state: reducer$
    };
}
...
//# sourceMappingURL=ReactRealm.js.map