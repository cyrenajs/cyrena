...
export default function getConditionalCmp(cond, getCmp) {
    ...
    return getDynamicCmp(cond$.fold((...[, next]) => ({ cond: next, key: String(Boolean(next)) }), { cond: false, key: 'false' }), next => getCmp(next.cond));
}
//# sourceMappingURL=getConditionalCmp.js.map